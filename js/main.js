...
function colonySelect() {
    const colonyData = {
        mentality: [
            {name: 'Допитливість', desc: 'Базис людської натури',
                effect: {temper: {'Мислитель': 30, 'Розвідник': 20}, exploringMult: 2, joinGlobalMarket: true}},
            {name: 'Гарт', desc: 'Цей народ потребує лише мінімум для виживання і за потреби готовий жити без благ. Одиниця населення цієї нації виробляє одиницю праці та споживає одиницю їжі, води та житла',
            ...
            {name: 'Неомонархізм', desc: 'Ідеологія цієї нації, яка вірить у абсолютну владу Неомонарха',
                effect: {supportLaw: {'Неомонархія': 50, 'Олігархія': 20, 'Міжнародні вибори': -20}, temper: {'Нарцис': 25,'Плутократ': 15, 'Меланхолік': 15, 'Офіцер': 10}}},
            {name: 'Хай-тек', desc: 'Ця нація звикла до переваг життя, які дають технології. Одиниця населення цієї нації виробляє одиницю праці та споживає одиницю їжі, води, житла, електрики та послуг',
                effect: {resoursePerPop: {'Їжа': -1, 'Вода': -1, 'Житло': -1, 'Електрика': -1, 'Послуги': -1, 'Праця': 1}}},
        ],
        nations: [
            {name: 'Колоністи', color: '#93006c', icon: '🔭', desc: 'Колоністи з Неомонархії, які заселили і бажають експлуатувати нову планету', mentality: ['Допитливість', 'Гарт', 'Неомонархізм'], pop: 20, land: 30},
        ],
    };
    setup(colonyData);
    displayPNM();
